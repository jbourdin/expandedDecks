 ...
 *
 * Explanations are stored as Markdown so the public page renders them
 * with the same formatting that pokemon.com used in the original
 * announcement (italic expansion names, bold card / Ability / Pokémon
 * names) and admins can edit them with the rich-text editor.
 *
 * Applied two ways:
...
final readonly class BannedCardSeedData
{
    ...
    // ---------- Shared rationales (multiple cards in one announcement) ----------
    ...
    private const array SEEDS = [
        ...
        'Duskull' => [
            ...
            'sourceUrl' => self::STELLAR_CROWN_URL,
        ...
        'Flapple' => [
            ...
            'sourceUrl' => self::MEGA_EVOLUTION_URL,
        ...
        'Ghetsis' => [
            ...
            'sourceUrl' => self::CELESTIAL_STORM_URL,
            'explanation' => self::GHETSIS_HEX_MANIAC_RATIONALE,
        ],
        'Hex Maniac' => [
            'effectiveDate' => '2018-08-17',
            'sourceUrl' => self::CELESTIAL_STORM_URL,
        ...
        'Lysandre\'s Trump Card' => [
            ...
            'sourceUrl' => self::LYSANDRE_BULBANEWS_URL,
        ...
        'Maxie\'s Hidden Ball Trick' => [
            'effectiveDate' => '2019-02-15',
            'sourceUrl' => self::TEAM_UP_URL,
            'explanation' => self::MAXIE_RATIONALE,
        ],
        ...
        'Medicham V' => [
            ...
            'sourceUrl' => self::PERFECT_ORDER_URL,
            'explanation' => "In combination with various Abilities and effects that place damage counters on the opponent's Pokémon, **Medicham V**'s **Yoga Loop** attack can be used to take an additional turn and win the game quickly. To weaken this style of deck, **Medicham V** will be banned from the Expanded format.",
        ],
        'Milotic' => [
            'effectiveDate' => '2020-11-27',
            'sourceUrl' => self::VIVID_VOLTAGE_URL,
        ...
        'Oranguru' => [
            'effectiveDate' => '2020-11-27',
            'sourceUrl' => self::VIVID_VOLTAGE_URL,
            'explanation' => self::ORANGURU_SABLEYE_RATIONALE,
        ],
        'Puzzle of Time' => [
            'effectiveDate' => '2018-08-17',
            'sourceUrl' => self::CELESTIAL_STORM_URL,
        ...
        'Scoop Up Net' => [
            ...
            'sourceUrl' => self::PALDEAN_FATES_URL,
        ...
        'Shaymin-EX' => [
            'effectiveDate' => '2020-11-27',
            'sourceUrl' => self::VIVID_VOLTAGE_URL,
            'explanation' => self::SHAYMIN_EX_RATIONALE,
        ],
        'Shaymin EX' => [
            'effectiveDate' => '2020-11-27',
            'sourceUrl' => self::VIVID_VOLTAGE_URL,
