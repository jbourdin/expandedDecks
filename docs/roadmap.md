...
| F2.15 | Archetype playstyle tags       | Low      | Not started | F2.10            |
...
**Progress: 12/30 done · 0 partial · 18 not started**
...
| 9     | Content, Archetypes & Low Priority | 12  | 0       | 18          | 30    |
| 10    | Labels & Scanning                 | 0    | 0       | 7           | 7     |
| 11    | Play Pokemon QR Integration       | 0    | 0       | 2           | 2     |
| 12    | Quality & Security Consolidation  | 0    | 0       | 2           | 2     |
|       | **Total**                         | **69** | **0**  | **31**      | **100** |

All 100 features from [features.md](features.md) are represented exactly once.
