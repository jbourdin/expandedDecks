...
- [PokéSprite](https://github.com/msikma/pokesprite) — Pokemon box sprite database (Gen 8 style, 68×56 px). Sprites are copied into the project's public assets at build time for archetype pictograms (F2.12). Pokemon sprites are © Nintendo/Creatures Inc./GAME FREAK Inc.
