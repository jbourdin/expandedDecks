...
- [docs/technicalities/translation_workflow.md](docs/technicalities/translation_workflow.md) — Content-translation workflow: `#[Translatable]` attribute, revision tables, snapshot listener
